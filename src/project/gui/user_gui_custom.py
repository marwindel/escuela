...
class AppUser(ctk.CTk, tk.Tk):
    ...
    def mostrar_tabla(self):
        ...
        self.tabla.column('Nombre', width=250,  anchor=tk.CENTER)
        self.tabla.column('Usuario', width=250,  anchor=tk.CENTER)
    ...
    def actualizar_user_clave(self):
        ...
        if self.id_user:
            ...
            messagebox.showinfo("Éxito", "Clave del usuario actualizados correctamente.")
