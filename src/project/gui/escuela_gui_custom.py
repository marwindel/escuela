...
class App(ctk.CTk, tk.Tk ):
    ...
    def __init__(self, usuario_log=None):
        super().__init__()
        self.id_material = None
        self.user_log = usuario_log
    ...
    def mostrar_titulo(self):
        etiqueta = ctk.CTkLabel(self, text="Administrar Materiales", bg_color="#9CD5FF", font=("Calibri", 48, "bold"), text_color="black")
    ...
    def mostrar_formulario(self):
        ...
        aula.grid(row=2, column=0, sticky=ctk.W, pady=20, padx=5)
        ...
        self.aula_t.grid(row=2, column=1)
    ...
    def mostrar_tabla(self):
        ...
        self.tabla.column('Registrado_por', width=180,  anchor=tk.W)
    ...
    def validar_materiales(self):
        ...
        if(self.descripcion_t.get() and self.cantidad_t.get() and self.aula_t.get()):
   ...
   # def abrir_v_aula(self):
    ...
    def guardar_material(self):
        ...
        if self.id_material is None:
            ...
            materiales = Materiales(self.id_material, desc, cant, id_aula, None, fecha_creacion, fecha_actualizacion)
